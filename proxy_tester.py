...
# 
pub_urls = ['http://web.mit.edu/facts/mission.html',
            'http://www.cs.ucla.edu/news/current-news',];

pub_conc = ['http://irl.cs.ucla.edu/data/kernel_org.html',];
...
def usage():
     print "Usage: proxy_tester.py path/to/proxy/binary [port] [specifyport]"
     print "  Omit the port argument for port 12345."
     print "  If third parameter specified, port parameter will be added while starting proxy and client."
